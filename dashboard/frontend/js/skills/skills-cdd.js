...
(function () {
    ...
    window.SkillsRegistry.registerBatch([
        { id: 'cdd-market-research', name: 'CDD Market Research', icon: '&#127760;', category: 'cdd',
          ...
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'web-fetch',role:'enhance'},{id:'companies-house-lookup',role:'enhance'},{id:'dashboard-context',role:'enhance'},{id:'pdf-export',role:'output'},{id:'clipboard-copy',role:'output'}],
          features: ['web-scraping','ch-data','pipeline-metrics'],
          tags: ['cdd', 'market', 'research', 'analysis'] },
        ...
        { id: 'cdd-competitor-analysis', name: 'Competitor Analysis', icon: '&#127942;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }, { label: '&#128424; Export', handler: 'exportPdf' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'web-fetch',role:'enhance'},{id:'companies-house-lookup',role:'enhance'},{id:'hubspot-read',role:'enhance'},{id:'clipboard-copy',role:'output'}],
          tags: ['cdd', 'competitor', 'swot', 'analysis'] },
        ...
        { id: 'cdd-financial-snapshot', name: 'Financial Snapshot', icon: '&#163;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }, { label: '&#128424; Export', handler: 'exportPdf' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'companies-house-lookup',role:'enhance'},{id:'pdf-export',role:'output'}],
          tags: ['cdd', 'financial', 'companies-house'] },
        ...
        { id: 'cdd-digital-presence-audit', name: 'Digital Presence Audit', icon: '&#128187;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }, { label: '&#128424; Export', handler: 'exportPdf' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'web-fetch',role:'enhance'},{id:'dashboard-context',role:'enhance'},{id:'clipboard-copy',role:'output'}],
          tags: ['cdd', 'digital', 'seo', 'social'] },
        ...
        { id: 'cdd-customer-sentiment', name: 'Customer Sentiment', icon: '&#128172;', category: 'cdd',
          ...
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'web-fetch',role:'enhance'},{id:'clipboard-copy',role:'output'}],
          tags: ['cdd', 'sentiment', 'reviews', 'nps'] },
        ...
        { id: 'cdd-executive-summary', name: 'Generate CDD Summary', icon: '&#128196;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }, { label: '&#128424; Export', handler: 'exportPdf' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'dashboard-context',role:'enhance'},{id:'pdf-export',role:'output'},{id:'clipboard-copy',role:'output'}],
          features: ['pipeline-metrics','ch-data'],
          tags: ['cdd', 'summary', 'executive', 'report'] },
        ...
        { id: 'cdd-full-pack', name: 'Run Full CDD Pack', icon: '&#128640;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }, { label: '&#128424; Export', handler: 'exportPdf' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'web-fetch',role:'enhance'},{id:'companies-house-lookup',role:'enhance'},{id:'hubspot-read',role:'enhance'},{id:'monday-read',role:'enhance'},{id:'dashboard-context',role:'enhance'},{id:'pdf-export',role:'output'}],
          features: ['web-scraping','ch-data','crm-read','monday-read','dashboard-context'],
          tags: ['cdd', 'full', 'pack', 'comprehensive'] },
        ...
        { id: 'companies-house-filing-alert', name: 'Filing Alert', icon: '&#128276;', category: 'cdd',
          ...
          execute: { type: 'api-call', inputs: [
            ...
            resultType: 'json' },
          requires: ['companies-house'],
          blocks: [{id:'companies-house-lookup',role:'core'},{id:'notification',role:'output'}],
          tags: ['filing', 'alert', 'companies-house'] },
        ...
        { id: 'cdd-revenue-triangulation', name: 'Revenue Triangulation', icon: '&#128208;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'companies-house-lookup',role:'enhance'},{id:'web-fetch',role:'enhance'},{id:'clipboard-copy',role:'output'}],
          tags: ['revenue', 'triangulation', 'estimate'] },
        ...
        { id: 'cdd-management-team-review', name: 'Management Team Review', icon: '&#128101;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'linkedin-profile',role:'enhance'},{id:'clipboard-copy',role:'output'}],
          tags: ['management', 'team', 'review', 'people'] },
        ...
        { id: 'cdd-risk-register', name: 'CDD Risk Register', icon: '&#9888;', category: 'cdd',
          ...
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'dashboard-context',role:'enhance'},{id:'pdf-export',role:'output'},{id:'clipboard-copy',role:'output'}],
          tags: ['risk', 'register', 'cdd', 'assessment'] },
        ...
        { id: 'cdd-comparable-valuations', name: 'Comparable Valuations', icon: '&#128200;', category: 'cdd',
          ...
          execute: { type: 'ai-query', inputs: [
            ...
            resultType: 'markdown', actions: [{ label: '&#128203; Copy', handler: 'copyResult' }, { label: '&#128424; Export', handler: 'exportPdf' }] },
          requires: ['groq'],
          blocks: [{id:'ai-analyse',role:'core'},{id:'web-fetch',role:'enhance'},{id:'dashboard-context',role:'enhance'},{id:'pdf-export',role:'output'},{id:'clipboard-copy',role:'output'}],
          tags: ['valuation', 'comparable', 'multiples', 'ma'] }
    ]);
})();
